...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dodaj_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_dodaj_t qt_meta_stringdata_dodaj = {
    {
QT_MOC_LITERAL(0, 0, 5) // "dodaj"
...
const QMetaObject dodaj::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dodaj.data,
      qt_meta_data_dodaj,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *dodaj::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dodaj.stringdata))
